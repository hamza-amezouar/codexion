...
/*   Updated: 2026/07/01 14:48:07 by hamezoua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	heap_extract_min_helper(t_dongle *dongle, int current)
{
	...
	if (left_child < dongle->heap_size
		&& dongle->heap[left_child].priority < dongle->heap[smallest].priority)
		smallest = left_child;
	if (right_child < dongle->heap_size
		&& dongle->heap[right_child].priority < dongle->heap[smallest].priority)
