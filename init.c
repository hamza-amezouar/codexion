...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/20 10:20:18 by hamezoua          #+#    #+#             */
/*   Updated: 2026/06/20 12:18:53 by hamezoua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int init_coders(t_simulation *sim)
{
    ...
    while (i < sim->config->number_of_coders)
    {
        ...
        sim->coders[i].right_dongle = &sim->dongles[(i + 1) % sim->config->number_of_coders];
        i++;
    }
    return (0);
}
